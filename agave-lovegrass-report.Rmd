...
# 3. Replace percent sign (%) and number sign (#) in figures
...
# 6. Fix p-values of 0.
# 7. Check 2.1 graph, N = 18, but only 16 points?
#     + Have different symbol shape for each Treatment
#     + Add regression lines for each Treatment
# 8. Add example of logistic regression explanation of coefficient estimates
# 9. Update author info and add
```
