...
# NOTE: plot 5, row 1, no treatment was assigned (NA) in original Excel file; 
# changed to S+W following consultation with A. Gill 2019-11-01
...
ggsave(filename = "output/agave-count-plot.pdf", plot = agave_count_plot)
```
